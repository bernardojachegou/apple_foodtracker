...
//  FoodTracker
//
//  Created by Michel Bernardo on 06/04/21.
//
...
class MealTableViewController: UITableViewController {
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    // The view cells are reused and should be dequeued using cell identifier.
    ...
    // Fetches the appropriate meal for the data source layoyt.
